...
export default function RosterClient({ artists, pageTitle = 'THE ROSTER', kicker = 'GOOD PEOPLE ARTIST MANAGEMENT', context }: RosterClientProps) {
          ...
          {view === 'list' ? (
            <div className={styles.rosterList}>
              {sorted.map((artist, i) => (
                <Link
                  key={artist.slug}
                  href={context ? `/roster/${artist.slug}?from=${context}` : `/roster/${artist.slug}`}
